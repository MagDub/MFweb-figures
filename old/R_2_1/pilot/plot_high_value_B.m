...
pickedhigh_SH = (chosenOption_splitinAB.ABD.freq(:,2)+chosenOption_splitinAB.AB.freq(:,2)+chosenOption.BD.freq(:,1))*100/n_trials_perhor;
pickedhigh_LH = (chosenOption_splitinAB.ABD.freq(:,4)+chosenOption_splitinAB.AB.freq(:,4)+chosenOption.BD.freq(:,4))*100/n_trials_perhor;
