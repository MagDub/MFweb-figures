...
function [] = plot_param_mod12_Q0(col_,ybounds, increment, signif, hight_signif)
    ...
    b2S = bar(x_ax(1),nanmean(param), 'FaceAlpha', 0.2, 'BarWidth',0.5, 'FaceColor',col_(1,:), 'EdgeColor', col_(2,:),'LineWidth',1.2); hold on;
    
    param = param';
    scatter(x_ax(1)*ones(1,size(param,1))+noise_plot, param', 18, col_(2,:), 'filled', 'MarkerFaceAlpha', 0.3); hold on;
