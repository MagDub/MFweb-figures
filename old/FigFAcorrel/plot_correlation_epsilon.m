...
title_ = 'Impulsivity';
render_corr(var1,var2, param_bounds_var1, param_bounds_var2, title_, 'a', 'NorthEast', 'BIS score', {'value-free','random exploration'})
...
render_corr(var1,var2, param_bounds_var1, param_bounds_var2, title_, 'b', 'NorthEast', 'BIS motor subscore', {'value-free','random exploration'})
...
render_corr(var1,var2, param_bounds_var1, param_bounds_var2, title_, 'c', 'NorthEast', 'BIS motor subscore - motor', {'value-free','random exploration'})
...
param_bounds_var2 = [0,0.5];  
title_ = 'OCD';
render_corr(var1,var2, param_bounds_var1, param_bounds_var2, title_, 'd', 'NorthEast', 'OCIR score', {'value-free','random exploration'})
...
param_bounds_var2 = [0,0.5];  
title_ = 'ADHD';
render_corr(var1,var2, param_bounds_var1, param_bounds_var2, title_, 'e', 'NorthEast', 'ASRS score', {'value-free','random exploration'})
...
render_corr(var1,var2, param_bounds_var1, param_bounds_var2, title_, 'f', 'NorthEast', 'ASRS hyper-impuls subscore', {'value-free','random exploration'})
...
render_corr(var1,var2, param_bounds_var1, param_bounds_var2, title_, 'g', 'NorthEast', 'Factor score', {'value-free','random exploration'})

% %Export
% addpath('../../../export_fig')
% export_fig(['FigFAcorrel_F3_epsilon.tif'],'-nocrop','-r200')
