...
render_corr(mod12SH,mod8SH, param_bounds_eta, [0:1:5], title_, 'a', 'NorthWest');

subplot(1,3,2);
title_ = 'Pilot data: \fontsize{22}\eta_{LH}';
render_corr(mod12LH,mod8LH, param_bounds_eta, [0:1:5], title_, 'b', 'NorthWest');

subplot(1,3,3);
title_ = 'Pilot data: Both \fontsize{22}\eta';
render_corr([mod12SH; mod12LH],[mod8SH; mod8LH], param_bounds_eta, [0:1:5], title_, 'c', 'NorthWest');

% % Export
% addpath('../../../export_fig')
% export_fig(['./Fig_corr_eta.tif'],'-nocrop','-r200')

export_fig(['/Users/magdadubois/GoogleDrive/UCL/MFweb/figures/Fig11.png'],'-nocrop','-r200')
