...
n_sim = 20000;
thompson_file = '/Users/magdadubois/MFweb/data/sim_recov/thompson_rand_Norm/';
...
legend_position = [0.619929453262786 0.600708502024292 0.0846560846560847 0.090080971659919];
...
legend_position = [0.311287477954145 0.333502024291499 0.0846560846560844 0.090080971659919];
...
legend_position = [0.518518518518518 0.331477732793522 0.0846560846560844 0.090080971659919];
render_corr(para_vals_fitted(:,2),para_vals_generated(:,2), param_bounds_sgm0, [0.5:0.5:2.5], title_, 'g', legend_position);

% % Export
% addpath('../../../export_fig')
% export_fig(['Fig_corr.tif'],'-nocrop','-r200')

export_fig(['/Users/magdadubois/GoogleDrive/UCL/MFweb/figures/Fig8.png'],'-nocrop','-r200')