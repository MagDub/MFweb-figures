...
scatter(fitted, generated, 18, col_(2,:), 'filled', 'MarkerFaceAlpha', 0.02);
plot([-12 12],[-12 12],':k')
...
ylabel('Simulated value','FontName','Arial','Fontweight','bold','FontSize',12);
xlabel('Recovered value','FontName','Arial','Fontweight','bold','FontSize',12);
