function [row_, row_desc] = fct_compute_table_row_score(data_per_trial, to_del)
    ...
    % concat
    row_ = {num2str(mean(mean_),4), '', num2str(nanmean(inter_),4), sprintf('%.2e',nanmean(slope_)), stats_}';
