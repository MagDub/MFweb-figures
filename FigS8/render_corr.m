function [p] = render_corr(fitted, generated, param_bounds, ticks_, title_, letter, legend_position)
...
scatter(fitted, generated, 20, col_(2,:), 'filled', 'MarkerFaceAlpha', 0.15);
plot([-12 12],[-12 12],':k')
