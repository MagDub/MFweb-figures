...
scatter(var1, var2, 8, col_(2,:), 'filled', 'MarkerFaceAlpha', 0.1); hold on;
...
% string output
if p<0.001
    l = legend([b1, b2],strcat('r=',num2str(round(r,2)), '***')); 
else
...
xlabel(var1_label,'FontName','Arial','Fontweight','bold','FontSize',10);
ylabel(var2_label,'FontName','Arial','Fontweight','bold','FontSize',10);
