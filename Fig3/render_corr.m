function [p] = render_corr(var1, var2, param_bounds_var1, param_bounds_var2, title_, letter, legend_position, var1_label, var2_label)
...
% Number and title
text(0+0.7, 1-0.1,corr_string,'Units', 'Normalized', 'VerticalAlignment', 'Top','FontSize', 16, 'Fontweight','normal')
