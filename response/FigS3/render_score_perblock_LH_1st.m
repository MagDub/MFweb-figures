function [] = render_score_perblock_LH_1st()
    ...
    % plot
    plot([1:4], first_LH, 'Color',[col(1,:) 0.3]); hold on;
    plot([1:4],nanmean(first_LH,1),'LineWidth',3, 'Color',[col(2,:) 1]); 
    errorbar([1:4],nanmean(first_LH),nanstd(first_LH)./sqrt(n),'.','color','k'); 
    ...
    % Number and title
    text(0-0.2, 1+0.3,'b','Units', 'Normalized', 'VerticalAlignment', 'Top','FontSize', 26)
