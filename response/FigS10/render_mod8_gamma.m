...
function [] = render_mod8_gamma(ybounds, increment, signif, hight_signif)
    ...
    title(['\fontsize{18} Information bonus{\fontsize{22} \gamma}'],'interpreter','tex','Fontweight','normal','FontName','Arial');
