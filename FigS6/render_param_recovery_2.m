...
function [] = render_param_recovery_2()
    ...
    xlabel('Recovered parameter','FontName','Arial','Fontweight','bold','FontSize',12);
    ...
    % Number and title
    text(0-0.15, 1+0.17,'','Units', 'Normalized', 'VerticalAlignment', 'Top','FontSize', 26)
