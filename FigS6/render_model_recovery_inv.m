...
function [] = render_model_recovery_inv()


    load('./model_recov_inv.mat');
    ...
    % Number and title
    text(0-0.15, 1+0.17,'c','Units', 'Normalized', 'VerticalAlignment', 'Top','FontSize', 26)
    t=title('Inversion matrix','FontSize', 18, 'FontName','Arial', 'Fontweight','normal');
