function [] = main_mat_param(c_ax, inc)  

    addpath('../cmocean/')

    path = '../../data_analysis/10_stats/corr_bonferroni/corr_allQ/';
    file_r = 'param_r.csv';
    file_pc = 'param_pval_corr.csv';
    file_pu = 'param_pval_uncorr.csv';
    ...
    xticks([1:9])
    xlim([0.5 9.5])
    xticklabels({'BIS', 'ASRS', 'AQ10', 'CFS', 'OCIR', 'STAI', 'IUS', 'SDS', 'LSAS'})
    ...
    text(0-0.1, 1+0.2,'b','Units', 'Normalized', 'VerticalAlignment', 'Top','FontSize', 26)  
end
