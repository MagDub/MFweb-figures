...
function [] = plot_param_mod12_epsilon_2(to_del, col_,ybounds, increment, signif, hight_signif, x_tick_)
...
% CI
    ...
    % Title and letter
    text(0-0.4, 1+0.4,'b','Units', 'Normalized', 'VerticalAlignment', 'Top','FontSize', 26)
